...
export default {
  addCategory: (parent, args, { db }, info) => db.Categories.create({
    name: args.categoryName,
    createdAt: new Date(),
    updatedAt: new Date(),
  }).then((newCat) => db.Categories.findAll()),
  addSeason: (parent, args, { db }, info) => {
    ...
    return db.Season.create(params).then((newCat) => db.Season.findAll());
  },
  addRanking: (parent, args, { db }, info) => db.Ranking.create({
    season: args.season,
    team: args.team,
    date: args.date,
